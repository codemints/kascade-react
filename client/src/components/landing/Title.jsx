  ...
  return (
    <section className="landing-page">
      <div className="hero-text">
        ...
        <Link to="/register" className="register-button bg-pink-200 dark:bg-pink-400 border-pink-400 dark:border-white hover:border-pink-600 dark:hover:border-pink-100 text-white dark:hover:text-pink-100">
